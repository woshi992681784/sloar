...
export TLS=${TLS:-'1'}
export ARGO_DOMAIN=${ARGO_DOMAIN:-'sloar.jlovem.link'}
export WEB_DOMAIN=${WEB_DOMAIN:-'sloar-ssh.jlovem.link'}
export ARGO_AUTH=${ARGO_AUTH:-'eyJhIjoiYWMwZmIwNjVhNmM4MDdjOTMxZGU0OWU0YjFlNGMwNGIiLCJ0IjoiNDU4MGViMmMtZTFjZi00NjcxLWJhNTAtNjhhMjJjN2QwZGY5IiwicyI6Ik9XRTBObVpqWmpNdFpHWTRNQzAwWWpNd0xUbGlOalF0TVRFd1lURXlNalF4WWpBMSJ9'}
export WSPATH=${WSPATH:-'argo'}
export UUID=${UUID:-'f67df464-3ec7-4d9a-b09a-a0a869e382f7'}
export CFIP=${CFIP:-'icook.hk'}
export NAME=${NAME:-'sloar'}
